...
type ChannelServiceClient interface {
	GetChannel(ctx context.Context, in *ChannelRequest, opts ...grpc.CallOption) (*ChannelReply, error)
}
...
func (c *channelServiceClient) GetChannel(ctx context.Context, in *ChannelRequest, opts ...grpc.CallOption) (*ChannelReply, error) {
	out := new(ChannelReply)
	err := c.cc.Invoke(ctx, "/ChannelService/GetChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChannelServiceServer interface {
	GetChannel(context.Context, *ChannelRequest) (*ChannelReply, error)
...
func (UnimplementedChannelServiceServer) GetChannel(context.Context, *ChannelRequest) (*ChannelReply, error) {
...
func _ChannelService_GetChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ChannelService/GetChannel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChannelServiceServer).GetChannel(ctx, req.(*ChannelRequest))
	}
